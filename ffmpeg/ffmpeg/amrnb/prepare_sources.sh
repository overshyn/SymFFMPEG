...
/cygdrive/c/Program Files/Common Files/Symbian/tools/unzip 26104-700_ANSI_C_source_code.zip
...
/cygdrive/c/job/AppMakr/patch/bin/patch <amrnb-intsizes.patch
/cygdrive/c/job/AppMakr/patch/bin/patch <amrnb-strict-aliasing.patch
/cygdrive/c/job/AppMakr/patch/bin/patch <amrnb-any-cflags.patch
